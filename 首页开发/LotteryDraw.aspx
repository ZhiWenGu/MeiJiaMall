<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LotteryDraw.aspx.cs" Inherits="首页开发.LotteryDraw" %>
            ...
            $(function () {
                ...
                $("#lottery a").click(function () {
                    if (click) {
                        ...
                        lottery.speed = 100;
                        $.post("luckdraw.ashx", { uid: 1 }, function (data) { //获取奖品，也可以在这里判断是否登陆状态
                            if (data != -1) {
                                $("#lottery").attr("prize_site", data - 1);
                                $("#lottery").attr("prize_id", data);
                                $("#lottery").attr("prize_name", data);
                                roll();
                                click = true;
                                return false;
                            }
